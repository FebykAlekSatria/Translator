import { Box, Button, Flex, FormLabel, Input, Select, Spacer, Textarea } from '@chakra-ui/react'
...
export default function Home() {
  ...
  return (
    <div>
      ...
      <Navbar />
      <Box width={{ base: '100%', sm: '100%', md: '80%' }} height='auto' mx='auto' borderRadius={5} pb={5} my={10} backgroundColor='' display={{ md: 'flex' }} >
